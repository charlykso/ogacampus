...
use App\Models\ItemMontlyReport;


class ItemReportChart extends BaseChart
{
         /**
     ...
     */
    public ?string $name = 'item_report_chart';
     ...
     * name will be used.
     */
    public ?string $routeName = 'item_report_chart';
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        $raw_result = ItemMontlyReport::where('year', $defaultYear)->get();  
        $rawCount = [];
