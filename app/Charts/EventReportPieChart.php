...
class EventReportPieChart extends BaseChart
{
   ...
   { 
     ...
     */
    public ?string $name = 'event_report_chart_pie';
     ...
     * name will be used.
     */
    public ?string $routeName = 'event_report_chart_pie';
    ...
    public function handler(Request $request): Chartisan
    {
        return Chartisan::build()
            ...
            ->dataset('Sample', [ 
                $this->reportViewRepository->getAllReport()['eventActive'], 
                $this->reportViewRepository->getAllReport()['eventPending']
                ]) ;
    }
}