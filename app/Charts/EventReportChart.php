...
use App\Models\EventMontlyReport;

class EventReportChart extends BaseChart
{
          /**
     ...
     */
    public ?string $name = 'event_report_chart';
     ...
     * name will be used.
     */
    public ?string $routeName = 'event_report_chart';
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        $raw_result = EventMontlyReport::where('year', $defaultYear)->get();  
        $rawCount = [];
