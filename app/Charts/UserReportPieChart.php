...
class UserReportPieChart extends BaseChart
{ 
     ...
     */
    public ?string $name = 'user_report_chart_pie';
     ...
     * name will be used.
     */
    public ?string $routeName = 'user_report_chart_pie';
    ...
    public function handler(Request $request): Chartisan
    {
        return Chartisan::build()
            ...
            ->dataset('Sample', [$this->reportViewRepository->getAllReport()['activeUser'], $this->reportViewRepository->getAllReport()['pendingUser'],]);
    }
}