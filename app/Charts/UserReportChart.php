...
class UserReportChart extends BaseChart
{
     ...
     */
    public ?string $name = 'user_report_chart';
     ...
     * name will be used.
     */
    public ?string $routeName = 'user_report_chart';
    ...
    {   
        ...
        $raw_result = UserMonthlyReport::where('year', $defaultYear)->get();  
        $rawCount = [];
