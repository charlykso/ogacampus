...
@section('content')
    ...
    <section id="TrdcS23SBdhdbORw" style="padding-bottom: 0px !important">
        <div class="app__container">
            <div>
                <h1 class="kjd__n3jhd83n">{{ $shop->business_name }}</h1>
                <p class="jjgbfoSN__djwg3jh">{{ $shop->tagline }}</p>
                @include('partials._shop_thumbnail')
            </div>
        </div>
        <section class="HdoiS__KSH3nSO">
            <div class="app__container">
                <div class="bg-white p-4 app__box__shadow">
                    ...
                    <p class="text__black">{{ $shop->description }}</p>
                </div>
            </div>
        </section>
        <section class="py-4">
            <div class="flex justify-center">
                <a href="{{ route('sellers.slug', $shop->user->uuid) }}" class="app__button btn__purple px-3 mr-3">View Seller</a>
