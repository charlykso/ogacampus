...
@section('content')
<style>
    .card-report:hover, .card-report:hover i{
        background-color:#6441e5;
        color: white;
        font-weight: bolder;
    }
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="{{route('admin.service.report')}}">
                ...
                <div class="col-md-3">
                    <a href="{{route('admin.item.report')}}">
                        <div class="card p-4 card-report rounded">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="h4 d-block font-weight-normal mb-2">{{$reports['itemCount']}}</span>
                                    <span class="font-weight-light">Items</span>
                                </div>
                ...
                <div class="col-md-3">
                    <a href="{{route('admin.schools')}}">
                        <div class="card p-4 card-report rounded">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="h4 d-block font-weight-normal mb-2">{{$reports['schoolCount']}}</span>
